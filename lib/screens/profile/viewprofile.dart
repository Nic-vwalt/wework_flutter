            ...
            child: Column(
              ...
              children: <Widget>[
                Align(
                  ...
                  child: RichText(
                    text: TextSpan(
                      text: "Name: " +document["FirstName"].toString()+" "+ document["LastName"].toString()+"\n",
                      style: TextStyle(
                          color: Colors.black
                      ),
                    ),
                ...
                Column(
                  children: <Widget>[
                    Align(
                      ...
                      child: RichText(
                        text: TextSpan(
                          text: "ID: \t" +document["FirstName"].toString()+" "+ document["LastName"].toString()+"\n",
                          style: TextStyle(
                              color: Colors.black
                          ),
                        ),
                    ...
                    Column(
                      children: <Widget>[
                        RichText(
                          text: TextSpan(
                            text: document["FirstName"].toString() + document["LastName"].toString()+"\n",
                            style: TextStyle(
                                color: Colors.black
                            ),
                          ),
